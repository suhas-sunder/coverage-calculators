...
export const meta: Route.MetaFunction = () => {
  const canonical = "https://www.coveragecalculators.com/terms-of-service";

  const title = "Terms of Service | coveragecalculators";
  const description =
    "Read the coveragecalculators Terms of Service. Learn about your rights and responsibilities when using coveragecalculators.com.";

  const ogImage = "https://www.coveragecalculators.com/og/coveragecalculators-terms.jpg";
  ...
  return [
    ...
    { property: "og:site_name", content: "coveragecalculators" },
    { property: "og:title", content: title },
    { property: "og:description", content: description },
    { property: "og:type", content: "website" },
    { property: "og:url", content: canonical },
    { property: "og:image", content: ogImage },
    { property: "og:image:alt", content: "coveragecalculators terms of service" },
...
export default function TermsOfService() {
  ...
  const canonicalUrl = "https://www.coveragecalculators.com/terms-of-service";
    ...
    <main className="mx-auto max-w-[1200px] px-6 py-10 text-slate-700">
      ...
      <div className="flex flex-col gap-8 leading-relaxed">
        <section className="flex flex-col gap-4">
          ...
          <p>
            We are coveragecalculators (https://www.coveragecalculators.com) ("Company", "we",
            "us", "our").
          </p>

          <p>
            We operate the website https://www.coveragecalculators.com (the "Site"), as
          ...
          <p>
            You can contact us by email at admin@coveragecalculators.com or by mail to
            https://www.coveragecalculators.com, Toronto, Ontario, Canada.
          </p>

          <p>
            These Legal Terms constitute a legally binding agreement made
            between you, whether personally or on behalf of an entity ("you"),
            and coveragecalculators, concerning your access to and use of the Services.
          ...
          <p>
            The Services are intended for a general audience. If you are under
            the age of 13, you may not use the Services. If you are under the
            age of majority in your jurisdiction, you may use the Services only
